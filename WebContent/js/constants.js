...
var CON_SCENE_TYPE = [
                      ...
                      {name:"黒皮椅(Black Leather Chair)",image:"heipiyi.png",info:["提前10天预订单价（RMB）：100.00","现场租赁单价（RMB）：120.00","押金（RMB）：200.00"]},
                      {name:"单人沙发(Single-Seat Sofa)",image:"danrenshafa.png",info:["提前10天预订单价（RMB）：300.00","现场租赁单价（RMB）：350.00","押金（RMB）：500.00"]},
                      ...
                      {name:"询问台(Information Counter)",image:"zixuntai.png",info:["提前10天预订单价（RMB）：150.00","现场租赁单价（RMB）：200.00","押金（RMB）：300.00"]},
